...
void Matrix4f::invert()
{
    ...
    */
	...
	b[0][2] = invdet  * (m_[0][1] * (m_[1][2] * m_[3][3] - m_[1][3] * m_[3][2]) + m_[0][2] * (m_[1][3] * m_[3][1] - m_[1][1] * m_[3][3]) + m_[0][3] * (m_[1][1] * m_[3][2] - m_[1][2] * m_[3][1]));
	b[0][3] = -invdet * (m_[0][1] * (m_[1][2] * m_[2][3] - m_[1][3] * m_[2][2]) + m_[0][2] * (m_[1][3] * m_[2][1] - m_[1][1] * m_[2][3]) + m_[0][3] * (m_[1][1] * m_[2][2] - m_[1][2] * m_[2][1]));
	b[1][0] = -invdet * (m_[1][0] * (m_[2][2] * m_[3][3] - m_[2][3] * m_[3][2]) + m_[1][2] * (m_[2][3] * m_[3][0] - m_[2][0] * m_[3][3]) + m_[1][3] * (m_[2][0] * m_[3][2] - m_[2][2] * m_[3][0]));
	b[1][1] = invdet  * (m_[0][0] * (m_[2][2] * m_[3][3] - m_[2][3] * m_[3][2]) + m_[0][2] * (m_[2][3] * m_[3][0] - m_[2][0] * m_[3][3]) + m_[0][3] * (m_[2][0] * m_[3][2] - m_[2][2] * m_[3][0]));
	b[1][2] = -invdet * (m_[0][0] * (m_[1][2] * m_[3][3] - m_[1][3] * m_[3][2]) + m_[0][2] * (m_[1][3] * m_[3][0] - m_[1][0] * m_[3][3]) + m_[0][3] * (m_[1][0] * m_[3][2] - m_[1][2] * m_[3][0]));
	b[1][3] = invdet  * (m_[0][0] * (m_[1][2] * m_[2][3] - m_[1][3] * m_[2][2]) + m_[0][2] * (m_[1][3] * m_[2][0] - m_[1][0] * m_[2][3]) + m_[0][3] * (m_[1][0] * m_[2][2] - m_[1][2] * m_[2][0]));
	b[2][0] = invdet  * (m_[1][0] * (m_[2][1] * m_[3][3] - m_[2][3] * m_[3][1]) + m_[1][1] * (m_[2][3] * m_[3][0] - m_[2][0] * m_[3][3]) + m_[1][3] * (m_[2][0] * m_[3][1] - m_[2][1] * m_[3][0]));
	b[2][1] = -invdet * (m_[0][0] * (m_[2][1] * m_[3][3] - m_[2][3] * m_[3][1]) + m_[0][1] * (m_[2][3] * m_[3][0] - m_[2][0] * m_[3][3]) + m_[0][3] * (m_[2][0] * m_[3][1] - m_[2][1] * m_[3][0]));
	b[2][2] = invdet  * (m_[0][0] * (m_[1][1] * m_[3][3] - m_[1][3] * m_[3][1]) + m_[0][1] * (m_[1][3] * m_[3][0] - m_[1][0] * m_[3][3]) + m_[0][3] * (m_[1][0] * m_[3][1] - m_[1][1] * m_[3][0]));
	b[2][3] = -invdet * (m_[0][0] * (m_[1][1] * m_[2][3] - m_[1][3] * m_[2][1]) + m_[0][1] * (m_[1][3] * m_[2][0] - m_[1][0] * m_[2][3]) + m_[0][3] * (m_[1][0] * m_[2][1] - m_[1][1] * m_[2][0]));
	b[3][0] = -invdet * (m_[1][0] * (m_[2][1] * m_[3][2] - m_[2][2] * m_[3][1]) + m_[1][1] * (m_[2][2] * m_[3][0] - m_[2][0] * m_[3][2]) + m_[1][2] * (m_[2][0] * m_[3][1] - m_[2][1] * m_[3][0]));
	b[3][1] = invdet  * (m_[0][0] * (m_[2][1] * m_[3][2] - m_[2][2] * m_[3][1]) + m_[0][1] * (m_[2][2] * m_[3][0] - m_[2][0] * m_[3][2]) + m_[0][2] * (m_[2][0] * m_[3][1] - m_[2][1] * m_[3][0]));
	b[3][2] = -invdet * (m_[0][0] * (m_[1][1] * m_[3][2] - m_[1][2] * m_[3][1]) + m_[0][1] * (m_[1][2] * m_[3][0] - m_[1][0] * m_[3][2]) + m_[0][2] * (m_[1][0] * m_[3][1] - m_[1][1] * m_[3][0]));
	b[3][3] = invdet  * (m_[0][0] * (m_[1][1] * m_[2][2] - m_[1][2] * m_[2][1]) + m_[0][1] * (m_[1][2] * m_[2][0] - m_[1][0] * m_[2][2]) + m_[0][2] * (m_[1][0] * m_[2][1] - m_[1][1] * m_[2][0])); 
