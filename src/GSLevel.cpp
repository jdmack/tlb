...
bool GSLevel::init()
{
    ...
    //lightManager->createDirectionalLight(Vector3f(1,1,1), 0.1, 0.4, Vector3f(1,-1,0));
    lightManager->createPointLight(Vector3f(1,1,1), 0.2, 1, Vector3f(10,1,10), 1, 1, 0.1);
    lightManager->createPointLight(Vector3f(1,1,1), 0.2, 1, Vector3f(20,1,10), 1, 1, 0.1);
