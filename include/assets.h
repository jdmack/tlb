...
const std::string kAssetUICharacterPanel         = kPathUI + "character_panel.png";
const std::string kAssetUICharacterPanelSelected = kPathUI + "character_panel_selected.png";
